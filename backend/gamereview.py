...
def getEngineAnalysis(FENs):
    stockfish = Stockfish(path=r"stockfish-ubuntu-x86-64-avx2\stockfish\stockfish-ubuntu-x86-64-avx2", depth=16, parameters={"Threads": 1, "Minimum Thinking Time": 1, "Hash": 32, "Slow Mover": 100})
    response = []
